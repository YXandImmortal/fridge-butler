...
import com.yx.fridgebutler.util.ThemedSpecCaptcha;
...
public class CaptchaController {
    ...
    public void generateCaptcha(
        ...
        // 创建数字验证码，4位字符
        ThemedSpecCaptcha captcha = new ThemedSpecCaptcha(130, 42, 4);

        // 根据主题设置背景色
        if ("dark".equals(theme)) {
            captcha.setBackground(ThemedSpecCaptcha.BG_DARK);
        } else {
            captcha.setBackground(ThemedSpecCaptcha.BG_LIGHT);
        }
        ...
        log.info("验证码生成成功，验证码ID：{}，主题：{}", captchaId, theme);
    }

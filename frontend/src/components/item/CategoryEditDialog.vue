<template>
  <transition name="dialog-fade">
    <div v-if="visible" class="category-edit-dialog-overlay" @click.self="handleOverlayClick">
      <div class="category-edit-dialog">
        <div class="dialog-header">
          <div class="dialog-title-container">
            <i class="iconfont icon-edit dialog-icon" />
            <h3 class="dialog-title">编辑分类名称</h3>
          </div>
...
import { updateItemCategory } from '@/api/item'
...
const initForm = () => {
  if (props.categoryData) {
    form.categoryName = props.categoryData.categoryName || ''
  }
}

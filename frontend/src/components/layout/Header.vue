  ...
  <header class="app-header">
    ...
    <div class="header-left">
      <div class="logo-container">
        ...
        <div v-if="!isSuperAdmin" class="quick-guide-btn" @click="handleQuickGuideClick" title="快速上手指南">
    ...
    <div class="header-right">
      ...
      >
        ...
        <div>
          <div v-if="!isSuperAdmin" class="user-menu-item" @click="goToUserCenter">
            <i class="iconfont icon-user"/>
            <span>个人中心</span>
          </div>
          <div v-if="isSuperAdmin" class="user-menu-item is-warn" @click="handleChangePasswordClick">
...
const handlePopoverShow = async () => {
  ...
  try {
    ...
    if (res.code === 200) {
      recentNotifications.value = Array.isArray(res.data) ? res.data : []
    }

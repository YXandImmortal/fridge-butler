<template>
  <transition name="dialog-fade">
    <div v-if="visible" class="unit-type-edit-dialog-overlay" @click.self="handleOverlayClick">
      <div class="unit-type-edit-dialog">
        <div class="dialog-header">
          <div class="dialog-title-container">
            <i class="iconfont icon-edit dialog-icon" />
            <h3 class="dialog-title">编辑单位分类</h3>
          </div>
...
import { updateUnitType } from '@/api/item'
...
const initForm = () => {
  if (props.typeData) {
    form.typeName = props.typeData.typeName || ''
  }
}

    ...
    <div class="content-wrapper">
      ...
      <div class="fridge-illustration">
        <svg viewBox="0 0 200 280" class="fridge-svg">
          ...
          <text x="100" y="54" font-size="10" fill="var(--danger-color)" font-family="MiSans, sans-serif"
                font-weight="bold" text-anchor="middle">ERROR
          </text>
          <!-- 蒸汽/烟雾 -->
          <path d="M60 180 Q55 170 60 160 Q65 150 60 140" fill="none" stroke="var(--text-tertiary)" stroke-width="2"
                opacity="0.4">
            <animate attributeName="d"
                     values="M60 180 Q55 170 60 160 Q65 150 60 140;M60 175 Q65 165 60 155 Q55 145 60 135;M60 180 Q55 170 60 160 Q65 150 60 140"
                     dur="3s" repeatCount="indefinite"/>
            <animate attributeName="opacity" values="0.4;0.1;0.4" dur="3s" repeatCount="indefinite"/>
          </path>
          <path d="M100 185 Q95 175 100 165 Q105 155 100 145" fill="none" stroke="var(--text-tertiary)" stroke-width="2"
                opacity="0.3">
            <animate attributeName="d"
                     values="M100 185 Q95 175 100 165 Q105 155 100 145;M100 180 Q105 170 100 160 Q95 150 100 140;M100 185 Q95 175 100 165 Q105 155 100 145"
                     dur="2.5s" repeatCount="indefinite"/>
            <animate attributeName="opacity" values="0.3;0;0.3" dur="2.5s" repeatCount="indefinite"/>
          </path>
          <path d="M140 180 Q135 170 140 160 Q145 150 140 140" fill="none" stroke="var(--text-tertiary)"
                stroke-width="2" opacity="0.35">
            <animate attributeName="d"
                     values="M140 180 Q135 170 140 160 Q145 150 140 140;M140 175 Q145 165 140 155 Q135 145 140 135;M140 180 Q135 170 140 160 Q145 150 140 140"
